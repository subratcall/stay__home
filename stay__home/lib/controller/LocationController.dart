...
class LocationController extends GetxController {
   ...
   * 이 둘 간의 성능적 차이는 없으며, 문법적 차이로 오는 부작용도 없다.
  ...
  checkLocationParams(double _latitudeData, double _longitudeData) {
    if (_latitudeData > latitudeData + 0.00100 ||
        _latitudeData < latitudeData - 0.00100 ||
        _longitudeData > longitudeData + 0.00100 ||
        _longitudeData < longitudeData - 0.00100) {
    ...
    print("현재 집 = $latitudeData:$longitudeData");
    update();
  }
